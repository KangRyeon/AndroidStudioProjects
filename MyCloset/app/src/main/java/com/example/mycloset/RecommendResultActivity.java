...
public class RecommendResultActivity extends AppCompatActivity implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Log.d("RecommendResultActivity", ip);

            URL connectUrl = new URL(ip+url_request);       // 스프링프로젝트의 home.jsp 주소(url_request : "/selectClothesbyCategoryNColor")
            ...
            if (conn != null) {
                ...
                String color = clothes_upper.getColor();
                String category = clothes_upper.getCategory();
                ...
                if(url_request.equals("/selectClothesbyCategoryNColor")) {
                    ...
                    writer.write("&upper_color=" + clothes_upper.getColor());
                    writer.write("&lower_category=" + clothes_lower.getCategory());
                    writer.write("&lower_color="+clothes_lower.getColor());
                    writer.flush();
                }
