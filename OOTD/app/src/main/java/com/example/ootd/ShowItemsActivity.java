...
import com.example.ootd.ClosetActivity;
import com.example.ootd.ModifyItemActivity;
import com.example.ootd.PopupDeleteActivity;
        ...
        for (int i=0; i<list.length; i++){
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(onclick_foldername.equals("accessory")) {
                        if(set.getAccessory1() == null) {
                            set.setAccessory1(files);
                            Log.d("set의 accessory1에 들어있는것", set.getAccessory1());
                        }
                        else if(set.getAccessory2() == null) {
                            set.setAccessory2(files);
                            Log.d("set의 accessory2에 들어있는것", set.getAccessory2());
                        }
                        else if(set.getAccessory3() == null) {
                            set.setAccessory3(files);
                            Log.d("set의 accessory3에 들어있는것", set.getAccessory3());
                        }
                    }
