...
public class SelectCameraGalleryRecommendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selectcameragalleryrecommend);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK) {
            ...
            if (requestCode == 1) {
                ...
                Intent intent = new Intent(SelectCameraGalleryRecommendActivity.this, RecommendActivity.class);
    ...
    public void checkPermission() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (cameraPermission == PackageManager.PERMISSION_GRANTED && writeExternalStoragePermission == PackageManager.PERMISSION_GRANTED) {
                ...
                Log.d("권한", "권한 설정 요청");
                ActivityCompat.requestPermissions(SelectCameraGalleryRecommendActivity.this
